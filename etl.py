...
def process_song_file(cur, filepath):
    """Reads songs log file row by row, 
       selects needed fields and inserts 
       them into song and artist tables.
        Parameters:
...
def process_log_file(cur, filepath):
    ...
    filters by NexSong,selects needed fields,transforms them and inserts
...
def main():
    """Function used to extract, transform all data from song and user
        activity logs and load it into a PostgreSQL DB
        Usage: python etl.py
    """
